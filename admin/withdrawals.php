...
if (isset($_GET['update_status'])) {
    ...
    $result = $db->setQuery("UPDATE withdrawals SET status='$status' WHERE id='$withdrawal_id';");
    if ($status == "Approved") {
        $email_class->sendWithdrawalApprovedEmail($user_id, $amount);
    } else if ($status == "Rejected") {
        $email_class->sendWithdrawalDeclinedEmail($user_id, $amount);
    }
    $admin->goTo("withdrawals", "updated");
}
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i> Withdrawals
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $result = $db->setQuery("SELECT * FROM withdrawals;");
