    ...
    if ($numrows2 == 0) {
        ...
        if ($numrows == 0) {
            ...
            if ($password == $confirmpassword) {
                ...
                $user_id = uniqid();
                $result = $user->createUser($user_id, $username, $firstname, $lastname, $email, $phone, "empty", "empty", $password, $withdrawal_code);
                if ($result) {
    ...
    <section class="auth-page">
        <div class="auth-container">
            ...
            <form action="" method="POST">
                ...
                <input type="text" placeholder="Withdrawal Code" maxlength="4" minlength="4" name="withdrawal_code" class="field" required>
