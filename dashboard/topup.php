...
if (isset($_POST['submit'])) {
    ...
    $deposit_id = uniqid();
    $result = $user->addDeposit($deposit_id, $session_id, "Topup", $amount, $coin_type, $wallet_address, $transaction_slip, $from_wallet_address);
    $user->updateDetail($session_id, "pending_deposit", $amount, "+");
    $txn_ref = RAND(10000, 100000);
    $email_class->sendTopupEmail($session_id, $coin_type, $amount, $wallet_address, $txn_ref);
...
<head>
    ...
    <title>degirotrading - Topup</title>
                            ...
                            <div class="col-xl-8 col-lg-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Topup Funds</h6>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            You are provided with a very convenient method to Topup using Bitcoin, Ethereum and USDT
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-primary mb-3" style="width:100%;" name="submit">Request Topup</button>
